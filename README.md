...
- [s40747-025-02204-0.pdf](https://github.com/user-attachments/files/26257051/s40747-025-02204-0.pdf)

### Authors:
- Jiyan Salim Mahmud (jiyan@inf.elte.hu)
- Zakarya Farou (zakaryafarou@inf.elte.hu)
- Imre Lendák (lendak@inf.elte.hu)

TODO: Add more details about the research paper (when it was published, from where, etc.)
